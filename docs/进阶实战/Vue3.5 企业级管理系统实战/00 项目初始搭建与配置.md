...
> 1. 本项目 Node 版本：23.5.0 （应该 20+就行，可以根据包管理器提示升级自己的 Node 版本）
...
![图片](../../images/202506230008169.webp)

![图片](..\..\images\202506230008191.webp)
...
![图片](../../images/202506230009035.webp)

启动后访问 `http://localhost:5173/`

![图片](../../images/202506230009506.webp)

## **工具集成**

ESLint 用于代码质量检查，Prettier 专注于代码格式化，EditorConfig 帮助统一编码风格，而 Husky 通过 Git 钩子强制执行代码检查，Lint-staged 仅对暂存文件应用 linters，Commitlint 则确保提交信息遵循一定的规范。这些工具共同构成了一个强大的代码质量和提交规范流程。
...
![图片](../../images/202506230035679.webp)
...
![图片](../../images/202506230036493.webp)

安装后，点击图标，选择【添加到工作区建议】。

![图片](../../images/202506230036813.webp)

点击后，会在项目文件夹 .vscode 下的 extensions.json 中添加配置，没有的话手动添加一下。

![图片](../../images/202506230037398.webp)

在 package.json 中添加脚本，即可通过 npm run lint 进行校验，代码文件中也会有提示。

![图片](../../images/202506230037695.webp)

![图片](..\..\images\202506230037761.webp)

![图片](../../images/202506230037566.webp)
...
![图片](../../images/202506230038385.webp)
...
![图片](../../images/202506230039568.webp)

安装后，点击图标，选择【添加到工作区建议】。

![图片](../../images/202506230039223.webp)

点击后，会在项目文件夹 .vscode 下的 extensions.json 中添加配置，没有的话手动添加一下。

![图片](../../images/202506230039066.webp)

在设置中，搜索 formatter ，选择 Prettier-Code formatter

![图片](../../images/202506230040763.webp)

同时，选择保存时设置文件格式。

![图片](..\..\images\202506230040852.webp)
...
![图片](../../images/202506230041374.webp)

安装后，点击图标，选择【添加到工作区建议】。

![图片](../../images/202506230041994.webp)

点击后，会在项目文件夹 .vscode 下的 extensions.json 中添加配置，没有的话手动添加一下。

![图片](../../images/202506230041347.webp)
...
![图片](../../images/202506230044700.webp)

![图片](..\..\images\202506230044888.webp)

如下图，配置好后，在执行 git commit 时，会先进行代码校验，校验通过后才可以提交。

修改报错前：

![图片](../../images/202506230044898.webp)

修改报错后：

![图片](..\..\images\202506230044223.webp)
...
![图片](../../images/202506230045435.webp)
...
![图片](../../images/202506230046331.webp)
...
![图片](../../images/202506230046457.webp)

符合规范时提交成功：

![图片](..\..\images\202506230046445.webp)
