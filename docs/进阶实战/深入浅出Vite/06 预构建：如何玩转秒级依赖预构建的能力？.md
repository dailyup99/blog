...
<img src="../../images/202508241238511.png" />
...
<img src="../../images/202508241240756.png" />

我在应用代码中调用了 debounce 方法，这个方法会依赖很多工具函数，如下图所示:

<img src="../../images/202508241240433.png" />
...
<img src="../../images/202508241242497.png" />
...
<img src="../../images/202508241302564.png" />
...
![image-20250824131035043](../../images/202508241310085.png)
...
接着，我们正式学习了预构建的相关配置—— entries 、 include 、 exclude 和 esbuldOptions ，并且重点介绍了 include 配置的各种使用场景和使用姿势。最后，我们讨论了一类特殊情况，即第三方包出现了问题该怎么办，分别给你介绍了两个解决思路:
