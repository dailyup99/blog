...
github搜索省市区，找到[Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China)

下载下来，找到dist目录下的pca-code.json，引入到项目中
...
<img src="http://139.196.79.103:9001/myimages/imgs/202409011343545.png" alt="image-20240901134337435" style="zoom:67%;" />
...
![image-20240901142329564](http://139.196.79.103:9001/myimages/imgs/202409011423627.png)
...
当使用app.use的时候就会去调用组件里面的install方法，可以是install方法，或者是一个对象返回install属性
