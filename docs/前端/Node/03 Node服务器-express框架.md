...
![image-20240713160500681](http://139.196.79.103:9001/myimages/imgs/202407131605763.png)
...
执行next()，就会app.use，因为app.use是一个中间件。
...
app.use可以匹配任意中间件，尽管这里可以匹配到/home，但是middleware01会先匹配
...
![image-20240713172944213](http://139.196.79.103:9001/myimages/imgs/202407131729296.png)

## **编写解析request body中间件**

<img src="http://139.196.79.103:9001/myimages/imgs/202407131730456.png" alt="image-20240713173003358" style="zoom:67%;" />

## **应用中间件 – express提供**

**但是，事实上我们可以使用expres内置的中间件或者使用body-parser来完成：**

<img src="http://139.196.79.103:9001/myimages/imgs/202407131731368.png" alt="image-20240713173105316" style="zoom:67%;" />

**如果我们解析的是 application/x-www-form-urlencoded：**

<img src="http://139.196.79.103:9001/myimages/imgs/202407131731478.png" alt="image-20240713173131416" style="zoom:67%;" />
...
![image-20240713174259548](http://139.196.79.103:9001/myimages/imgs/202407131742600.png)
...
<img src="http://139.196.79.103:9001/myimages/imgs/202407131748035.png" alt="image-20240713174830980" style="zoom:67%;" />
...
这样每次请求的日志就会被记录到logs/access.log中

![image-20240713175030252](http://139.196.79.103:9001/myimages/imgs/202407131750374.png)

**上传文件，我们可以使用express提供的multer来完成：**

<img src="http://139.196.79.103:9001/myimages/imgs/202407131748486.png" alt="image-20240713174855424" style="zoom:67%;" />

## 应用中间件 – 单个文件上传

![image-20240713180936615](http://139.196.79.103:9001/myimages/imgs/202407131809677.png)
...
![image-20240713180954147](http://139.196.79.103:9001/myimages/imgs/202407131809196.png)

但是当我们想查看uploads文件夹里面的图片文件时发现是打不开的，因为没有后缀名，需要自己补上.jpg才能显示。

![image-20240713181025317](http://139.196.79.103:9001/myimages/imgs/202407131810404.png)

## **上传文件中间件 – 添加后缀名**

**上传文件，我们可以使用express提供的multer来完成：**

<img src="http://139.196.79.103:9001/myimages/imgs/202407131817142.png" alt="image-20240713181733074" style="zoom:67%;" />
...
上面配置文件还是上传到uploads文件夹中，只不过多了自定义文件的名字，并且也有了后缀。

## 应用中间件 – 多个文件上传

![image-20240713182125323](http://139.196.79.103:9001/myimages/imgs/202407131821384.png)
...
<img src="http://139.196.79.103:9001/myimages/imgs/202407131924950.png" alt="image-20240713192414873" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/202407131934318.png" alt="image-20240713193412268" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/202407132005236.png" alt="image-20240713200523168" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/202407132013176.png" alt="image-20240713201320105" style="zoom:67%;" />
...
![image-20240713201541584](http://139.196.79.103:9001/myimages/imgs/202407132015702.png)

那么我们在浏览器就可以直接访问

![image-20240713201512691](http://139.196.79.103:9001/myimages/imgs/202407132015968.png)

也可以将之前的react项目打包之后的build文件夹放进来进行部署

![image-20240713201824509](http://139.196.79.103:9001/myimages/imgs/202407132018639.png)

然后浏览器访问`http://localhost:9000/`,本质上访问的就是`http://localhost:9000/index.html`

![image-20240713201922497](http://139.196.79.103:9001/myimages/imgs/202407132019903.png)

## **服务端的错误处理**

![02_服务器返回错误信息的两种方案](http://139.196.79.103:9001/myimages/imgs/202407132026897.png)

后端还是正常返回200，只不过会返回自定义的code。

next方法可以传参，传一个错误码进去，中间件可以有4个参数，第一个参数就是错误码，这样错误的处理和正确响应返回就区分开。
