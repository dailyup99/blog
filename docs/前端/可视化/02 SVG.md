...
![image-20230803214628581](http://139.196.79.103:9001/myimages/imgs/image-20230803214628581.png)
...
SVG2.x Change From SVG1.x ( https://www.w3.org/TR/SVG/changes.html )
...
![image-20230804201936507](http://139.196.79.103:9001/myimages/imgs/image-20230804201936507.png)
...
![image-20230804202405595](http://139.196.79.103:9001/myimages/imgs/image-20230804202405595.png)
...
![image-20230804202550150](http://139.196.79.103:9001/myimages/imgs/image-20230804202550150.png)
...
由于 SVG 是一个 XML 文件格式。在编写XML文档时，通常是推荐编写XML声明。因为在 XML 1.0 中，XML 声明是可选的，推荐写但不是强制性。

然而，在 XML 1.1 中，声明是强制性的，如果没有声明，则自动暗示该文档是 XML 1.0 文档。所以这里建议大家在编写SVG文件时也编写一个XML 声明。
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805092512467.png" alt="image-20230805092512467" style="zoom:67%;" />
...
因为在XML1.1命名空间规范中建议，不带前缀的属性（带前缀xlink:href）命名空间的名称是没有值的，这时命名空间的值必须
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805101354606.png" alt="image-20230805101354606" style="zoom:67%;" />

## **SVG Grid 和 坐标系**

**SVG 使用的坐标系统（网格系统）和 Canvas的差不多。坐标系是以左上角为 (0,0) 坐标原点，坐标以像素为单位，x 轴正方向**
...
![image-20230805102149705](http://139.196.79.103:9001/myimages/imgs/image-20230805102149705.png)
...
\<svg>的 transform 属性可以用来移动、旋转、缩放SVG中的某个元素，如\<svg>中某个元素用了变形，该元素内部会建立
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805102306042.png" alt="image-20230805102306042" style="zoom: 67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805102550177.png" alt="image-20230805102550177" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805102619223.png" alt="image-20230805102619223" style="zoom:67%;" />
...
viewBox 也可理解为是用来指定用户坐标系大小。因为SVG的图形都是绘制到该区域中。用户坐标系可以比视口坐标系更小或更大，也可
...
在viewBox属性上设置视图框为视口大小的1/4。

暂时不改变这个视图框左上角，将\<min-x>将\<min-y>设置为零。

视图框的宽度和高度将是视口宽度和高度的1/4。
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805110038873.png" alt="image-20230805110038873" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805110616981.png" alt="image-20230805110616981" style="zoom:67%;" />
...
将preserveAspectRatio设置为xMinYMin的效果
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805111023763.png" alt="image-20230805111023763" style="zoom: 67%;" />

如果改为none效果如下：在y轴上被拉伸

<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805111115924.png" alt="image-20230805111115924" style="zoom: 67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805130039166.png" alt="image-20230805130039166" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805131936974.png" alt="image-20230805131936974" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805132131108.png" alt="image-20230805132131108" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805132316388.png" alt="image-20230805132316388" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805132706484.png" alt="image-20230805132706484" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805132559111.png" alt="image-20230805132559111" style="zoom:67%;" />

当使用fill为transparent时，发现折线到最后一个点没有闭合
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805133223448.png" alt="image-20230805133223448" style="zoom:67%;" />

## **绘制-路径（path）**

**下面用SVG来绘制路径（path）**

\<path>元素可能是 SVG 中最常见的形状。你可以用 < path >元素绘制矩形（直角矩形或圆角矩形）、圆形、椭圆、折线形、
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805133711476.png" alt="image-20230805133711476" style="zoom:67%;" />
...
每一个命令都用一个关键字母来表示，比如，字母“M”表示的是“Move to”命令，当解析器读到这个命令时，它就知道你是打算

移动到某个点。跟在命令字母后面的，是你需要移动到的那个点的 x 和 y 轴坐标。比如移动到 (10,10) 这个点的命令，应该写成“M 

10 10”命令。这一段字符结束后，解析器就会去读下一段命令。每一个命令都有两种表示方式，一种是用大写字母，表示采用绝对

定位。另一种是用小写字母，表示采用相对定位（例如：从上一个点开始，向上移动 10px，向左移动 7px）。
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805134157107.png" alt="image-20230805134157107" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805142240653.png" alt="image-20230805142240653" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805142424324.png" alt="image-20230805142424324" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805143457740.png" alt="image-20230805143457740" style="zoom:67%;" />
...
fill可以写在样式style里面，也可以写在text元素的属性上
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805143730560.png" alt="image-20230805143730560" style="zoom:67%;" />
...
![image-20230805143642983](http://139.196.79.103:9001/myimages/imgs/image-20230805143642983.png)
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805143801168.png" alt="image-20230805143801168" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805150121544.png" alt="image-20230805150121544" style="zoom:67%;" />
...
克隆的节点是不可见的，当给\<use>元素应用CSS样式时须小心。因为克隆的 DOM 不能保证都会继承 \<use>元素上的CSS 
...
<body>
  ...
  <svg width="300" height="300" xmlns="http://www.w3.org/2000/svg" >
    <!-- 
      它的宽和高是没有生效的 ????  只用use引用的图形是 svg 或 symbol 才会起作用
     -->
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805150819769.png" alt="image-20230805150819769" style="zoom:67%;" />
...
![image-20230805152214372](http://139.196.79.103:9001/myimages/imgs/image-20230805152214372.png)
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805152643093.png" alt="image-20230805152643093" style="zoom:67%;" />

SVG制作精灵图

首先，去阿里图标的官网去下载svg

第二步，来到https://www.zhangxinxu.com/sp/svgo/这个网址，将下载好的svg拖拽进去

这样就能拿到svg的代码了，复制精灵图的代码，如下红色框所示

![image-20230805154239191](http://139.196.79.103:9001/myimages/imgs/image-20230805154239191.png)

不过代码格式有点乱，百度搜索在线xml格式化，将上面的代码放进去
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805180950224.png" alt="image-20230805180950224" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805181336098.png" alt="image-20230805181336098" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805181436676.png" alt="image-20230805181436676" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805181935136.png" alt="image-20230805181935136" style="zoom: 50%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805182316848.png" alt="image-20230805182316848" style="zoom:67%;" />
...
<body>
  ...
  <svg width="300" height="300" xmlns="http://www.w3.org/2000/svg" >
    ...
    <!-- 
      stroke , 而不是 fill dashoffset = 10向左偏移10px
     -->
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230805182419978.png" alt="image-20230805182419978" style="zoom:67%;" />
...
<body>
  ...
  <svg width="300" height="300" xmlns="http://www.w3.org/2000/svg" >
    ...
    <!-- 1.行内的样式 -->
    <!-- <rect class="rectangle" x="10" y="10" width="100" height="100"
     style="fill:red;"
    ></rect> -->
