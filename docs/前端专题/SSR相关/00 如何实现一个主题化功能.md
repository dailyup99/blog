...
主题化的功能对于 DOM 的结构变化不大，往往都是针对色调进行切换。顺着这个思路，如果我们定义两套变量，是不是就完成了对两套主题的配置？根据不同的主题，我们可以在 html 标签上来固定两个属性来区分。
...
![image.png](http://139.196.79.103:9001/myimages/imgs/202508161028213.png)
...
![image.png](http://139.196.79.103:9001/myimages/imgs/202508161028195.png)
