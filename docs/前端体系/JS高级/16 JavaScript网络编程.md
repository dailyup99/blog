...
![image-20230527202143344](http://139.196.79.103:9001/myimages/imgs/image-20230527202143344.png)

## **网页的渲染过程 – 前后端分离**

![image-20230527202206716](http://139.196.79.103:9001/myimages/imgs/image-20230527202206716.png)
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230527203446811.png" alt="image-20230527203446811" style="zoom:67%;" />

## **网页中资源的获取**

**我们网页中的资源通常是被放在Web资源服务器中，由浏览器自动发送HTTP请求来获取、解析、展示的。**

![image-20230527203536460](http://139.196.79.103:9001/myimages/imgs/image-20230527203536460.png)
...
![image-20230527203614019](http://139.196.79.103:9001/myimages/imgs/image-20230527203614019.png)
...
![image-20230527215726156](http://139.196.79.103:9001/myimages/imgs/image-20230527215726156.png)
...
![image-20230527220547927](http://139.196.79.103:9001/myimages/imgs/image-20230527220547927.png)

## **HTTP Response Header**

**响应的header中包括一些服务器给客户端的信息：**

<img src="http://139.196.79.103:9001/myimages/imgs/image-20230527220621672.png" alt="image-20230527220621672" style="zoom:67%;" />
...
将下载下来的crx拖到chrome://extensions/这里面，如果不能拖进去怎么办？

将下载下来的crx后缀名改成rar，然后进行解压，再将解压后的文件夹拖进去即可
...
![image-20240502101049493](http://139.196.79.103:9001/myimages/imgs/image-20240502101049493.png)
...
**XMLHttpRequest的status是用于记录xhr对象本身的状态变化，并非针对于HTTP的网络请求状态。**

**如果我们希望获取HTTP响应的网络状态，可以通过status和statusText来获取：**

![image-20230528025702610](http://139.196.79.103:9001/myimages/imgs/image-20230528025702610.png)
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230528044200826.png" alt="image-20230528044200826" style="zoom:50%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230528044856701.png" alt="image-20230528044856701" style="zoom:67%;" />

**基于async、await的使用方案：**

<img src="http://139.196.79.103:9001/myimages/imgs/image-20230528044917075.png" alt="image-20230528044917075" style="zoom:67%;" />
...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230528045021726.png" alt="image-20230528045021726" style="zoom:67%;" />
