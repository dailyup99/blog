...
练习二：定义一个变量 nickname，赋值成 coderwhy。定义一个变量 admin，将 nickname 赋值给 admin
...
数字 number 可以有很多操作，比如，乘法 \*、除法 /、加法 +、减法 - 等等。常见的运算符后续会专门讲解
...
![image-20221126230143127](../../images/image-20221126230143127.png)
...
![image-20221126232400938](../../images/image-20221126232400938.png)
...
![image-20221126232854069](../../images/image-20221126232854069.png)
