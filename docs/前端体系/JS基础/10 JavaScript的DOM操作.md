...
![image-20221219202136831](../../images/image-20221219202136831.png)
...
如果想将 box 字体改为红色，大小改为 24px，背景为绿色，一种做法是直接修改 style
...
如果想要精准的修改 css 属性的值，那么得使用 style，动态添加的 class 样式是写死的，没法改
...
![image-20221220202600477](../../images/image-20221220202600477.png)
...
![image-20221220212417939](../../images/image-20221220212417939.png)
...
下面来完成一个需求，当滚动 y 方向的距离超过 600 时，显示回到顶部按钮，否则隐藏该按钮。

加很多 br 是为了让 y 方向有滚动条
