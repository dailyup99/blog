...
![image-20230710222229249](../../images/image-20230710222229249.png)

## **事件对象 event**

**当某个事件触发时, 会产生一个事件对象, 并且这个对象被传入到回调函数中, 事件对象有哪些常见的属性呢?**

![image-20230710223323096](../../images/image-20230710223323096.png)
...
<img src="../../images/image-20230710230024474.png" />

**2.多手指触摸时不同**

<img src="../../images/image-20230710230044758.png" />

刚开始按住一个手指不放，后面又按了 2 个手指。
...
![image-20230710232424878](../../images/image-20230710232424878.png)
...
<view class="view1" capture-bind:tap="onView1CaptureTap" bindtap="onView1Tap">
  <view
    class="view2"
    capture-catch:tap="onView2CaptureTap"
    bindtap="onView2Tap"
  >
    <view
      class="view3"
