...
![image-20230709170001715](http://139.196.79.103:9001/myimages/imgs/image-20230709170001715.png)
...
![image-20230709183924165](http://139.196.79.103:9001/myimages/imgs/image-20230709183924165.png)
...
其中backgroundTextStyle是下拉 loading 的样式，仅支持 dark / light，但是默认是不开启下拉刷新的，如果想要开启下来刷新，需要来到页面，比如favor页面的favor.json文件开启下拉刷新
...
![img](http://139.196.79.103:9001/myimages/imgs/page-lifecycle.2e646c86.png)