...
<img src="http://139.196.79.103:9001/myimages/imgs/image-20230708145757516.png" alt="image-20230708145757516" style="zoom:80%;" />
...
如果你之前已经掌握了**Vue或者React等框架开发**，那么学习小程序是更简单的；
...
![image-20230709094229221](http://139.196.79.103:9001/myimages/imgs/image-20230709094229221.png)

## **使用VSCode开发**

**推荐一些插件：**

![image-20230709094314187](http://139.196.79.103:9001/myimages/imgs/image-20230709094314187.png)

## **创建小程序项目**

AppID在微信公众平台，扫描登录之后的开发管理=>开发设置

![image-20230709094451135](http://139.196.79.103:9001/myimages/imgs/image-20230709094451135.png)

## **小程序项目结构**

![image-20230709152142384](http://139.196.79.103:9001/myimages/imgs/image-20230709152142384.png)

创建页面的两种方式：

方式一：先在pages目录下鼠标右键新建文件夹，比如叫favor，然后在favor文件夹，鼠标右键新建Page，建完之后就会在app.json中看到新创建的页面，pages属性会多出pages/favor/favor，而且favor文件夹下有4个文件

![image-20230709151339779](http://139.196.79.103:9001/myimages/imgs/image-20230709151339779.png)

方式二：在app.json的pages属性中，新增加一个页面，我们在pages属性新增一个pages/order/order，保存代码左侧会自动新增一个页面

![image-20230709151510554](http://139.196.79.103:9001/myimages/imgs/image-20230709151510554.png)
...
![image-20230709164207778](http://139.196.79.103:9001/myimages/imgs/image-20230709164207778.png)
