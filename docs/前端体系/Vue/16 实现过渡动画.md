...
React 框架本身并没有提供任何动画相关的 API，所以在 React 中使用过渡动画我们需要使用一个第三方库 react-transition
...
<img src="..\..\images\image-20230603065243061.png" />
...
![image-20230603075441636](../../images/image-20230603075441636.png)
...
Vue 为了**知道过渡的完成**，内部是**在监听 transitionend 或 animationend**，到底使用哪一个取决于元素应用的 CSS 规则：
...
![image-20230603081855400](../../images/image-20230603081855400.png)

## **过渡的模式 mode**

**我们来看当前的动画在两个元素之间切换的时候存在的问题：**

<img src="..\..\images\image-20230603102208360.png" />
...
<img src="..\..\images\image-20230603104716918.png" />
...
上面为什么需要给要离开的元素加 position 为 absolute，见下图

<img src="..\..\images\image-20230603105249691.png" />

删除数字 6，本来 7 8 9 是要向左移过来的，但是因为 6 还占据着位置，导致无法移动过来。
...
<img src="..\..\images\image-20230603105439847.png" />
