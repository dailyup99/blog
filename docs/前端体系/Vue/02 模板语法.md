...
![image-20230502071023981](../../images/image-20230502071023981.png)

## **虚拟 DOM**

**如果我们不只是一个简单的 div，而是有一大堆的元素，那么它们应该会形成一个 VNode Tree：**

![image-20230502071126143](../../images/image-20230502071126143.png)

虚拟 DOM 有两个作用：

1.跨平台

![image-20230502071238814](../../images/image-20230502071238814.png)
...
![image-20230502072636833](../../images/image-20230502072636833.png)

## **没有 key 的操作（源码）**

![image-20230502072659746](../../images/image-20230502072659746.png)
...
![image-20230502072739775](../../images/image-20230502072739775.png)

## **有 key 执行操作（源码）**

![image-20230502072803505](../../images/image-20230502072803505.png)
...
![image-20230502072926902](../../images/image-20230502072926902.png)

**第二步的操作是从尾部开始进行遍历、比较：**

![image-20230502072944873](../../images/image-20230502072944873.png)

## **有 key 的 diff 算法如下（二）**

**第三步是如果旧节点遍历完毕，但是依然有新的节点，那么就新增节点：**

![image-20230502073043238](../../images/image-20230502073043238.png)

**第四步是如果新的节点遍历完毕，但是依然有旧的节点，那么就移除旧节点：**

![image-20230502073117103](../../images/image-20230502073117103.png)

## **有 key 的 diff 算法如下（三）**

**第五步是最特色的情况，中间还有很多未知的或者乱序的节点：**

![image-20230502073223164](../../images/image-20230502073223164.png)
