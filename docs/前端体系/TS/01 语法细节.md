...
**这是因为我们的对象在进行字面量推理的时候，info 其实是一个 {url: string, method: string}，所以我们没办法将一个 string**
...
注意：在**某些语言中，可能参数名称 num1 和 num2 是可以省略，但是 TypeScript 是不可以的**
...
<img src="../../images/image-20221203190623884.png" />
...
就会生成一个 tsconfig.json，搜索 this

在设置了 noImplicitThis 为 true 时， TypeScript 会根据上下文推导 this，但是在不能正确推导时，就会报错，需要我们明确

的指定 this

<img src="../../images/image-20221203201247258.png" />

在设置了 noImplicitThis 为 true 时， TypeScript 会根据上下文推导 this，但是在不能正确推导时，就会报错，需要我们明确

的指定 this

<img src="../../images/image-20221203201737365.png" />
...
<img src="../../images/image-20221203203709574.png" />

**OmitThisParameter**：

用于移除一个函数类型 Type 的 this 参数类型, 并且返回当前的函数类型

<img src="../../images/image-20221203203738066.png" />
